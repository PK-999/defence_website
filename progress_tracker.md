...
**Reconciled:** 8 September 2026. **Current state:** implementation is complete through T25, with T27 release documentation and CI in place. T00–T07 and T09–T25 are functional on automated checks; T08 and T26 publication remain blocked pending provider/accountable-editor inputs, and T28 remains planned pending the next collection scope. Playwright Chromium is installed and the current desktop/mobile browser suite passes.
