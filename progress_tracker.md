...
- [ ] Implement precise DB schemas for `Source`, `SourceVersion`, `Evidence`, `Claim`, and `EntityAlias`
- [ ] Transition from flat models to temporal modeling (e.g. `valid_from`, `valid_to` for relationships)

### Stage 2: Source Registry Validation
- [ ] Ingest the trusted source seed list (MoD, Armed Forces, Archives, etc.)
- [ ] Implement Tier A-D classification for sources
- [ ] Set up infrastructure for tracking source versions and fetching documents

### Stage 3: Golden Datasets
- [ ] Build Golden Dataset 1 (e.g., Aircraft in Indian Service), 100% source-backed
- [ ] Build Golden Dataset 2 (e.g., specific conflict or unit history), editorially reviewed

### Stage 4: Resolution & Coverage Mapping
- [ ] Implement robust entity resolution (aliases, contextual matches) without relying purely on fuzzy string matching
- [ ] Map internal coverage (known universe vs. source complete vs. editorially reviewed)

---

## VERSION 3: Immersive Storytelling
**Status:** Concept
