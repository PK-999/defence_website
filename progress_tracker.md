...
| T26 | First reviewed connected collection | T09,T17–20,T24 | Sourcing + complete reader journey | in-progress / blocked publication gate | [Candidate-package evidence](docs/verification/2026-09-07/T26/source-package.md); nine sources captured and hashed, eight draft entities validate/dry-run/apply cleanly in an isolated database. Accountable publication still requires the owner OIDC subject and a candidate evidence/relationship import. |
