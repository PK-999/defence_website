...
| T25 | Fail-closed extraction factory | T04,T06,T07 | PIPE-01–03 | functional | [Implementation evidence](docs/verification/2026-09-08/T25/implementation.md); locked Python tests cover missing source/model, ontology/quote validation, stable replay identities, and explicit CLI inputs. |
| T26 | First reviewed connected collection | T09,T17–20,T24 | Sourcing + complete reader journey | in-progress / blocked publication gate | [Source package](docs/verification/2026-09-07/T26/source-package.md) and [candidate evidence import](docs/verification/2026-09-08/T26/evidence-import.md); nine sources, twelve evidence rows, ten claims, and five relationships import idempotently into an isolated candidate database and validate cleanly. Accountable publication and the complete public journey still require the owner OIDC subject. |
| T27 | Release rehearsal/documentation | T00–T26 | Full test plan + rollback evidence | functional / blocked release gates | [Release evidence](docs/verification/2026-09-08/T27/release.md); CI workflow, local production commands, rollback rules, verified local production server, automated screenshots, and three-run local performance measurements are documented. OIDC, production storage, manual accessibility, accepted screenshots, and final deployment remain external gates. |
| T28 | Repeatable broader coverage | T27 | Per-collection release gate | in-progress / blocked publication gate | [Implementation evidence](docs/verification/2026-09-08/T28/implementation.md) and [source ledger](docs/verification/2026-09-08/T28/source-ledger.md); the finite 1971 starter collection imports five candidate entities, six sources, nine evidence rows, and three relationships, replays idempotently, and validates cleanly. Publication and source-journey acceptance require the owner OIDC subject; vessel-level specifications remain held. |
